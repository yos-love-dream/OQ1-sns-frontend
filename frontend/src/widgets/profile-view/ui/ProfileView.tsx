...
const FEED_TRANSITION_DELAY_BASE = 0.5;
const FEED_TRANSITION_DELAY_STEP = 0.07;
const FEED_TRANSITION_MAX_INDEX = 8;
...
const feedItemTransition = (index: number) => ({
  ...
  transition: {
    ...
    delay:
      FEED_TRANSITION_DELAY_BASE +
      Math.min(index, FEED_TRANSITION_MAX_INDEX) * FEED_TRANSITION_DELAY_STEP,
  },
});
